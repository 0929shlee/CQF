...
double CompQuality::compQualityCalculator(const Vector3D& cqiMatrix, const Vector3D& connectionMatrix)
{
    double res = 0;
...
double CompQuality::getCompQuality(const Vector3D& cqiMatrix, const Vector3D& connectionMatrix)
{
    double compQuality = compQualityCalculator(cqiMatrix, connectionMatrix);
